...
* For on-premises ONTAP configurations, the source and destination volumes must be running link:https://docs.netapp.com/us-en/ontap/data-protection/compatible-ontap-versions-snapmirror-concept.html[compatible ONTAP versions^].
