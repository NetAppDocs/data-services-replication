...
You can easily use a default backup policy with the default snapshot policy. The default backup policies replicate daily and weekly snapshot copies; it retains 7 daily and 52 weekly snapshot copies.
