...
+
To manage replication relationships with FSx for ONTAP file systems, after you log in to the NetApp Console, go to *Storage* > *Management* > *Systems*. Then select the FSx for ONTAP file system. Now you're in Workload Factory in the FSx for ONTAP resource screen, where you can manage the replication relationships for the file system. Select the FSx for ONTAP file system from the list of systems, and then select the *Replication relationships* tab to view and manage the replication relationships for the file system.
